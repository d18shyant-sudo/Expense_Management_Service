...
try:
    ...
    db.add(admin)
    db.flush()
    Finance_admin = Role(role_name="Finance_admin",created_by=admin.id)
    Manager = Role(role_name="Manager",created_by=admin.id)
    employee = Role(role_name="Employee",created_by=admin.id)
    Finance_Head = Role(role_name="Finance_Head",created_by=admin.id)
    db.add_all([Finance_admin,Manager,employee,Finance_Head,admin])
    db.flush()
    # # 2.categorys
    food = Category(name="Food")
    hotel = Category(name="Hotel")
    ...
    vinoth = Employee(name="Vinoth", email="vinoth@gmail.com", role_id=Finance_admin.id, is_active=True)
    ganesh = Employee(name="Ganesh", email="ganesh@gmail.com", role_id=Finance_Head.id, is_active=True)
    Manoj=Employee(name="Manoj",email="manoj@gmail.com",role_id=admin.id,is_active=True)
    ...
    db.add_all([IT,HR,Sales,Finance,admin])
    db.flush()
    ram.department_id=IT.id
    mani.department_id=IT.id
    siva.department_id=IT.id
...
>>>>>>> ac9febbefa2d6022e8580df0fd5e98ac7b4f9d81
    # 5. Account
